...
Implementace metody Binary Space Partitioning využívá rekurzivní rozdělování prostoru mapy na menší oblasti pomocí binární stromové struktury. Každý uzel stromu reprezentuje obdélníkovou oblast mapy, která může být dále rozdělena na dvě pod-oblasti.
...
Náhodná procházka je implementována v souboru \texttt{drunken\_generator.gd}. Algoritmus začíná ve středu mapy a postupně se přesouvá do jednoho ze čtyř směrů. Každý krok upravuje mapu vyřezáním průchozích buněk.

Praktická implementace kombinuje dva režimy vyřezávání. V základním režimu vytváří menší průchozí úseky, po určitém počtu kroků pak vloží větší 3x3 oblast. Tím se vygenerované prostředí neomezuje pouze na úzké chodby a obsahuje i širší otevřené části. Počet kroků mezi vložením větší oblasti je náhodný v definovaném intervalu.

Důležitým prvkem implementace je cílový počet podlahových dlaždic. Generování běží do okamžiku, kdy podlaha pokryje stanovené procento mapy. Díky tomu je výstup lépe kontrolovatelný napříč různými rozměry mapy.
