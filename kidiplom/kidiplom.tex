...
\subsubsection{Rogue}
Za zmínku stojí velmi významný herní titul s názvem Rogue, který má však mnohem větší popularitu než výše zmíněný Beneath Apple Manor, avšak právě Rogue měl velmi výrazný vliv právě i na nadcházející hry. Již podle názvu si lze domyslet, že právě díky této hře vznikl podžánr roguelike.
 
Hra byla představena již v roce 1980 vývojaři Michael Toy, Glenn Wichman a Ken Arnold. Rouge je obvykle popisováno jako jedna z prvních rougelike adventur, která představila permadeath, progres tedy nebylo možné ukládat a jakmile hráč zemřel, musel začít úplně od začátku. Cílem hry


source: http://pcg.wikidot.com/pcg-games:rogue
