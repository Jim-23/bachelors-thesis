...
Metoda je vhodná pro generování prostředí připomínajícího jeskyně \cite{Shaker2016}.
...
Významnou vlastností Godotu je podpora dlaždicových map (TileMap), které jsou při vývoji 2D her často využívány a~výrazně usnadňují samotné grafické ztvárnění. Tento způsob reprezentace je zároveň vhodný i~pro implementaci algoritmů procedurálního generování, protože poskytuje jednoduchou manipulaci s~jednotlivými buňkami mapy. Engine zároveň umožňuje spouštění a~testování ztvárněných metod.
...
Pokrytí mapy průchozím prostorem má u~tohoto algoritmu celkově rostoucí trend s~velikostí mapy, ale není čistě monotónní. Na menších mapách (20$\times$50, 70$\times$30) se pohybuje v~rozmezí 31,1--42,9 \%, přičemž mapa 20$\times$50 dosahuje vyšší hodnoty než větší mapa 70$\times$30. Na mapě 100$\times$100 činí pokrytí 43,8 \% a~na mapě 150$\times$150 dosahuje 54,1 \%.
...
\hline
Rooms    & 3,81  & 5,12  & 3,89  & 9,72   & 27,20  \\
BSP      & 2,93  & 5,51  & 3,83  & 9,03   & 20,39  \\
Drunkard's  & 4,65  & 8,33  & 7,43  & 22,34  & 55,67  \\
Cellular & 8,00  & 27,37 & 15,58 & 78,21  & 177,65 \\
Maze     & 3,64  & 5,79  & 4,63  & 10,09  & 23,62  \\
\hline
...
Z~hlediska pokrytí se v~naměřených výsledcích vyskytují anomálie způsobené tvarem mapy. Mapa 70$\times$30 dosahuje u~algoritmů Místností, BSP a~Bludiště nižšího pokrytí než mapa 20$\times$50, přestože celkový počet buněk je větší (2\,100 vs. 1\,000). Příčinou je tvar mapy -- nízký obdélník omezuje rozmístění místností i~dělení prostoru. U~Místností se do výšky 30 dlaždic nevejde plný počet místností minimální velikosti a~chodby zabírají větší podíl plochy. U~BSP a~Bludiště úzký tvar zmenšuje použitelné oblasti při dělení mřížky, čímž roste podíl stěn a~okrajů vůči průchozímu prostoru.

U~algoritmu BSP se navíc pokrytí na mapě 100$\times$100 (53,4 \%) mírně převyšuje hodnotu dosaženou na mapě 150$\times$150 (52,6 \%). Rozdíl je malý, ale naznačuje, že nárůst pokrytí BSP s~plochou mapy není zcela lineární.
...
Algoritmus Místností dosahuje na velkých mapách výrazně vyššího pokrytí a~zároveň nabízí přirozenější rozložení prostoru.
...
Algoritmus Bludiště byl do implementace zahrnut primárně pro demonstraci odlišného přístupu k~procedurálnímu generování. Generuje dokonalé bludiště. Z~hlediska dungeonových map je však méně vhodný, protože vytváří převážně úzké chodby bez většího otevřeného prostoru.
